$(function() {
    ...
    // 問題
    const MONDAI_LIST = [
      {yomi:'担々麵', text:'tantanmen'},
      {yomi:'パンダ', text:'panda'},
      {yomi:'かまいたち', text:'kamaitachi'},
      {yomi:'リオデジャネイロ', text:'riodejyaneiro'},
      {yomi:'全集中', text:'zensyuutyuu'},
      {yomi:'機関車', text:'kikansya'},
      {yomi:'メリーゴーランド', text:'meri-go-rando'},
      {yomi:'新聞紙', text:'shinbunshi'},
      {yomi:'東京都', text:'toukyouto'},
      {yomi:'生卵', text:'namatamago'},
    ];
